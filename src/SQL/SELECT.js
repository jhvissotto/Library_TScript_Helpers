...
function SELECT_log(opt = { log: true }) {
    ...
    const SELECT_ALL_ORDER_LIMIT_OFFSET = SELECT(['*'], 'Table', { orderby: ['RAND()'], limit: 10, offset: 10 });
    if (opt === null || opt === void 0 ? void 0 : opt.log) {
        ...
        console.log('>> SELECT_ALL_ORDER_LIMIT_OFFSET:', SELECT_ALL_ORDER_LIMIT_OFFSET, '\n');
    }
    return {
        SELECT_ALL,
        SELECT_COL,
